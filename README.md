...
Este proyecto es una implementación de un solucionador para el juego Sokoban. Actualmente incluye un motor de búsqueda desinformada (BFS).
...
- **algorithm**: Algoritmo de búsqueda a utilizar (actualmente soportado: `bfs`).
